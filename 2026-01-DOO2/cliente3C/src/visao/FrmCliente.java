...
import modelo.LimitedTextField;
...
public class FrmCliente extends JFrame {
	...
	private JLabel jLRenda;
	public JTextField JTRenda;
	private JLabel jLExtenso;
	public LimitedTextField JTExtenso;
	...
	private void inicializar() {
		...
		jTCpf = new JTextField();
		jLRenda = new JLabel();
		JTRenda = new JTextField();
		jLExtenso = new JLabel();		
		JTExtenso = new LimitedTextField(10);
		...
		jLRenda.setBounds(new Rectangle(11, 154, 170, 17));
		JTRenda.setBounds(new Rectangle(11, 171, 120, 21));	
		jLRenda.setText("Renda");	
		
		jLExtenso.setBounds(new Rectangle(11, 200, 170, 17));
		JTExtenso.setBounds(new Rectangle(11, 218, 560, 21));	
		jLExtenso.setText("Valor por Extenso");	
		...
		contentPane.add(jLRenda, null);
		contentPane.add(jLCpf, null);
		contentPane.add(jTCpf, null);
		contentPane.add(JTRenda, null);
		contentPane.add(jLExtenso, null);
		contentPane.add(JTExtenso, null);
